...
class updater_check_class {
    ...
    function plugin_key_empty_admin_notice() {
        ...
        <div class="error notice">
            <p><?php _e($this->plugin_name . ' needs a valid License Key! <a href="edit.php?post_type=fts_feeds&page=ft-gallery-license-page">Click here to add one</a> or you won\'t recieve updates. - <a href="https://www.slickremix.com/my-account/" target="_blank">You can get License Key Here.</a>', 'feed-them-social'); ?></p>
        </div>
    ...
    function plugin_key_not_valid_admin_notice() {
        ...
        <div class="error notice">
            <p><?php _e($this->plugin_name . ' - Your License Key is not active, expired, or is invalid. <a href="edit.php?post_type=fts_feeds&page=ft-gallery-license-page">Click here to add one</a> or you won\'t recieve updates. - <a href="https://www.slickremix.com/my-account/" target="_blank">You can get License Key Here.</a>', 'feed-them-social'); ?></p>
        </div>
